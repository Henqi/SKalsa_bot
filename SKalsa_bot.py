...
async def hakis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    day_url = 'https://avoinna24.fi/api/slot?filter[ismultibooking]=' + ismultibooking + '&filter[branch_id]=' + branch_id + '&filter[group_id]=' + group_id + '&filter[product_id]=' + product_id + '&filter[user_id]=' + user_id + '&filter[date]=' + day_as_string + '&filter[start]=' + day_as_string + '&filter[end]=' + day_as_string
